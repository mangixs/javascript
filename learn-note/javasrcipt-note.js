...
页面自动刷新代码 < meta http - equiv = "refresh"
content = "20" > 页面自动跳转 < meta http - equiv = "refresh"
content = "20;url=http://" > 页面自动刷新 < script language = "JavaScript" > function myrefresh() {
...
var） 函数方法是返回一个布尔值， 指出一个对象是否具有指定名称的属性。
var 存在返回true 不存在返回false
...
alert(arr[0]);
注意上面的alert(arr[0]);
这一句， 它会返回undifined。 这就意味着， 关联数组中， 不能再以传统的下标方式来访问数组元素而必须通过元素的名字。
